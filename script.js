...
const receitasCidade = [
  ...
  {
    nome: "Coxinha",
    ingredientes: "Massa de farinha, frango desfiado, temperos, óleo para fritar",
    preparo: "Recheie a massa com frango temperado, molde e frite até dourar.",
    imagem: "https://images.unsplash.com/photo-1610970862533-956ee4f0db19?auto=format&fit=crop&w=400&q=80"
  }
];
...
const receitasZonaRural = [
  ...
  },
  {
    ...
    ingredientes: "Milho verde, leite, açúcar, canela",
    preparo: "Cozinhe o milho com leite e açúcar até engrossar, sirva quente.",
    imagem: "https://images.unsplash.com/photo-1555992336-cbf73e7152b0?auto=format&fit=crop&w=400&q=80"
  }
];
...
function carregarReceitas() {
  ...
  receitasCidade.forEach(receita => {
    cidadeList.appendChild(criarCard(receita));
  });

  receitasZonaRural.forEach(receita => {
    ruralList.appendChild(criarCard(receita));
  });
}
